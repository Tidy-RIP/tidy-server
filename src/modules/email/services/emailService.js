...
export const sendPasswordResetEmail = async (email, token) => {
  ...
  const message = `
<div style="text-align: center; font-family:sans-serif; margin:20px 20px;padding:20px 20px; ; border-radius:20px ">
    <h1 style="color: #b565e2;margin-bottom: 20px">Tidy</h1>
    <h3 style="color: #b565e2;">Restablecimiento de Contraseña</h3>
    <p style="margin-bottom:30px">Hola, has solicitado restablecer tu contraseña. Haz clic en el botón de abajo para restablecerla:</p>
...
<div style="text-align: center; font-family:sans-serif; margin:20px 20px;padding:20px 20px; ; border-radius:20px ">
    ...
    <p style="margin-bottom:30px">Hola, Gracias por registrarte en Tidy. Haz clic en el botón de abajo para verificar tu email::</p>
    <div style=" margin-bottom:30px">
